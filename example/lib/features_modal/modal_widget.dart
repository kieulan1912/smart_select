...
import 'package:serp_smart_select/smart_select.dart';
    ...
    return Column(
      children: <Widget>[
        ...
        SmartSelect<int?>.single(
          title:
              'Overall, how satisfied are you with serp_smart_select package?',
        ...
        SmartSelect<int>.multiple(
          title:
              'Which of following words would you use to describe serp_smart_select?',
          ...
          modalValidation: (value) {
            return value.length > 0 ? '' : 'Chọn ít nhất một';
          },
          modalHeaderBuilder: (context, state) {
            return Container(
